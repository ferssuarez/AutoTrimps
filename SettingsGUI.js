...
function automationMenuInit() {
    ...
    newItem.appendChild(document.createTextNode("AutoHooey v" + ver));
...
function initializeAllTabs() {
    ...
    createTabs("Core", "Hooey's Fork Ver. " + ver + " / " + verDate + " ");
...
// Export/Import/Default settings
    createSetting('ImportAutoTrimps', 'Import AutoHooey', 'Import your AutoTrimps Settings. Asks you to name it as a profile afterwards.', 'infoclick', 'ImportAutoTrimps', null, 'Import Export');
    createSetting('ExportAutoTrimps', 'Export AutoHooey', 'Export your AutoTrimps Settings as a output string text formatted in JSON.', 'infoclick', 'ExportAutoTrimps', null, 'Import Export');
