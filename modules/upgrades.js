...
function buyUpgrades() {
    for (var upgrade in upgradeList) {
        ...
        if (upgrade == 'Coordination' && (getPageSetting('ManualCoords')===1 || !canAffordCoordinationTrimps() || (game.global.world < getPageSetting('AutoGen2End') && getPageSetting('ManualCoords')===2 && getHDRatio() < .0000001))) continue;
